...
$sql=" select A.book_by,A.book_contact,A.book_address,A.book_name,A.book_age,A.book_gender,C.origin_desc,B.dest_destination,A.book_departure,A.book_tracker from booked A,origin C,destination B where book_by='{$_SESSION['name']}' AND A.origin_id=C.origin_id AND A.dest_id= B.dest_id";
$res=mysqli_query($cn,$sql);
echo "<br>";echo "<br>";echo "<br>";
	echo "<h1 style='color:white'>My Ticket</h1>
  <div class='tbl-header' style='margin: 70px 70px 75px 100px'>
